...
// Check if there is a recently logged out user stored in the session
if(isset($_SESSION['recently_logged_out_user'])) {
  $recentlyLoggedOutUser = $_SESSION['recently_logged_out_user'];
} else {
  $recentlyLoggedOutUser = '';
}
...
if(isset($_POST['submit'])){
  ...
  if($result) {
    ...
    if(!$num > 0){
       echo '<script>alert("User doesnot exists. Please sign up first :)");</script>';
    } else {
